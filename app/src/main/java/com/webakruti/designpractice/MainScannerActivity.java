    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBarCodeScan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new IntentIntegrator(MainScannerActivity.this).setCaptureActivity(ScannerActivity.class).initiateScan();
            }
        });
        ...
        builder.setTitle("Scan Result")
                ...
                .setPositiveButton("Copy result", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MainScannerActivity.this, "Result copied to clipboard", Toast.LENGTH_SHORT).show();
